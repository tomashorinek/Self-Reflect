diff --git a//dev/null b/trainingDataStrong.js
index 0000000000000000000000000000000000000000..f8b96e0b4a10a04034c5f1eb838fdf40becb4594 100644
--- a//dev/null
+++ b/trainingDataStrong.js
@@ -0,0 +1,178 @@
+
+console.log("📥 trainingDataStrong.js loaded");
+const trainingDataStrong = {
+  "1-2": {
+    "Monday": [
...
+};
+
+export default trainingDataStrong;
