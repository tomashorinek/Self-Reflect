function loadConditioningData() {
  return new Promise((resolve, reject) => {
    window.conditioningFrequencies = {
     conditioningFrequencies.bodyweight['1-2'] = [
  {
    name: "Push-ups",
    sets: "3x12",
    alt: [
  ...
  },
  {
    ...
    alt: [
      "Wall Sit",
      "Goblet Squat (with backpack/dumbbell)"
    ]
  },
  {
    name: "Leg Raises",
...
conditioningFrequencies.bodyweight['3-4'] = {
  "Day 1": [
    {
      name: "Push-ups",
      sets: "3x12",
    ...
    },
    {
      name: "V-ups",
      sets: "3x10",
      alt: ["Toe Touches", "Hollow Body Hold"]
    },
    {
      name: "Bear Crawl forward + back",
      sets: "3x10",
  ...
  "Day 2": [
    ...
    },
    {
      name: "Russian Twists",
      sets: "2x20",
      alt: ["Seated Knee Tucks", "Resistance Band Seated Rotations"]
    }
  ],
  "Day 3": [
    {
    ...
    },
    {
      name: "Pike Push-ups",
      sets: "3x10",
      alt: ["Incline Push-ups", "Feet-Elevated Push-ups"]
    },
    {
      name: "Split Squats",
      sets: "3x15",
      alt: ["Step-back Lunges", "Bulgarian Split Squat (foot on chair)"]
    },
    {
      name: "Bicycle Crunches",
      sets: "3x20",
      alt: ["Dead Bug", "Cross-Body Mountain Climbers"]
    }
  ],
  "Day 4": [
    {
      ...
      sets: "2x10",
      alt: ["Up-Down Plank", "Shoulder Tap Push-up"]
    },
    {
      name: "Leg Raises",
      sets: "2x20",
    ...
    },
    {
      name: "Superman Reach",
      sets: "2x15",
      alt: ["Reverse Snow Angels", "Y-T-I Raises (on floor or bench)"]
    },
    {
      name: "Side Plank",
      sets: "2x30s",
      alt: ["Side-Lying Hip Raise", "Side Plank with Reach-Under"]
    }
  ]
};
conditioningFrequencies.bodyweight['5'] = {
  "Mon": [
    {
      name: "Push-ups",
      sets: "3x12",
  ...
  "Fri": [
    {
      name: "Jumping Jacks",
      sets: "3x20",
      alt: ["High Knees", "Seal Jacks"]
    },
    {
      name: "Jump Lunges",
      sets: "3x10",
      alt: ["Alternating Step-Back Lunges", "Skater Hops"]
    },
    {
      name: "Plank Hold",
      sets: "3x30s",
      alt: ["Low Plank", "Plank with Arm Reach"]
    }
  ],
  "Sat": [
    {
    ...
    },
    {
      name: "Superman Hold",
      sets: "2x15",
      alt: ["Bird-Dog Hold", "Resistance Band Face Pulls"]
    },
    {
      name: "Russian Twists",
      sets: "2x20",
...
conditioningFrequencies.bodyweight['5+'] = {
  ...
  "Sat": [
    {
      name: "Push-ups",
      sets: "Ladder up to failure",
      alt: ["Incline Push-ups", "Chest Press with Bands"]
    },
    {
      name: "Leg Raises",
      sets: "2x15",
