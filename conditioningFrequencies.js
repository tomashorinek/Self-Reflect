function loadConditioningData() {
  return new Promise((resolve, reject) => {
    window.conditioningFrequencies = {
        ...
        "3-4": {
          ...
          "Day 2": {
            ...
            workout: {
              ...
              exercises: [
                ...
                { name: "Air Squats", reps: "15x", description: "A lower body exercise targeting the quads, hamstrings, and glutes.", alternatives: ["Wall Sit", "Chair Squats"] },
          ...
          "Day 3": {
            ...
            workout: {
              ...
              exercises: [
                ...
                { name: "Pike Push-ups", reps: "10x", description: "Targets the shoulders and upper chest by simulating an overhead press.", alternatives: ["Incline Pike Push-ups", "Wall Handstand Hold"] },
                { name: "Split Squats", reps: "15x each leg", description: "A unilateral leg movement focusing on quads and glutes.", alternatives: ["Step-ups", "Bulgarian Split Squats"] },
                { name: "Bicycle Crunches", reps: "20x", description: "A core movement emphasizing obliques and hip flexors.", alternatives: ["Toe Touches", "Russian Twists"] }
              ]
            },
          ...
          "Day 4": {
            ...
            workout: {
              ...
              rounds: "2–3",
              exercises: [
                { name: "Side Plank", reps: "30s each side", description: "Strengthens the obliques and improves lateral stability.", alternatives: ["Side Plank with Reach", "Knee Side Plank"] },
                { name: "Push-up to Plank", reps: "10x", description: "Transitions between push-up and elbow plank to challenge the core and shoulders.", alternatives: ["Plank Up-Downs", "Modified Push-up to Plank"] },
                { name: "Leg Raises", reps: "20x", description: "Engages lower abs through controlled leg lifts.", alternatives: ["Flutter Kicks", "Reverse Crunches"] },
                { name: "Superman Reaches", reps: "15x", description: "Strengthens the lower back, glutes, and posterior chain.", alternatives: ["Bird Dog", "Cobra Raises"] }
              ]
            },
        ...
        "5+": {
          ...
          "Day 6": {
            ...
            workout: {
              ...
              rounds: 1,
              exercises: [
                { name: "Push-up Ladder", reps: "1–2–3–4–5... to failure", description: "Progressive push-up challenge with short rest to build endurance.", alternatives: ["Knee Push-ups", "Incline Ladder"] }
              ]
            },
      ...
      // Zde jsou definovány plány pro posilovnu (GYM) z původního souboru
      gym: {
        "1-2": [
        ...
        "5": {
          "Mon": [{ name: "Bike Intervals", sets: "6x30s on / 60s rest", alt: ["Rowing", "Treadmill Sprints"] }, { name: "Leg Press", sets: "3x15", alt: ["Smith Machine Squat", "Hack Squat", "Pendulum Squat"] }],
          "Tue": [{ name: "Kettlebell Swings", sets: "4x20", alt: ["DB Swings", "Jump Squats"] }, { name: "Push-ups", sets: "3x max reps", alt: ["Incline Push-ups", "Chest Press"] }],
          "Wed": [{ name: "Run or Incline Walk", sets: "20 min", alt: ["Bike", "Elliptical"] }, { name: "Plank Series", sets: "3x30s", alt: ["Side Plank", "Bird Dog"] }],
          "Fri": [{ name: "Barbell Complex", sets: "4 rounds", alt: ["DB Complex", "Full Body Circuit"] }, { name: "Jump Rope", sets: "5x1 min", alt: ["High Knees", "Jumping Jacks"] }],
          "Sat": [{ name: "Rowing Intervals", sets: "4x300m", alt: ["Bike Intervals", "Treadmill Sprints"] }, { name: "Leg Circuit", sets: "3 rounds", alt: ["Split Squats", "Step-ups"] }]
        },
        "5+": {
          "Mon": [{ name: "Full Body Circuit (Gym)", sets: "3 rounds", alt: ["DB Complex", "Barbell Complex"] }, { name: "Bike Sprint", sets: "6x30s", alt: ["Rowing Sprint", "Jump Rope Sprints"] }],
          "Tue": [{ name: "Strength Combo", sets: "Barbell Complex 4 rounds", alt: ["DB Combo Circuit", "Full Body Machine Circuit"] }],
          "Wed": [{ name: "Run Outdoors", sets: "20–30 min steady", alt: ["Row steady pace", "Bike Long Ride"] }],
          "Thu": [{ name: "Mobility & Recovery", sets: "Stretching 20–30 min", alt: ["Foam Rolling", "Yoga Flow"] }],
          "Fri": [{ name: "KB Swing + Wall Balls", sets: "4 rounds", alt: ["Thrusters", "Jump Squats"] }],
          "Sat": [{ name: "Treadmill Incline Sprint", sets: "8x20s / 40s rest", alt: ["Bike Sprint", "Assault Bike"] }],
          "Sun": [{ name: "Optional Cardio", sets: "30–45 min light jog or bike", alt: ["Hiking", "Row steady"] }]
        }
      }
    };
    
    // Zbytek kodu je pro zobrazení tooltipu
